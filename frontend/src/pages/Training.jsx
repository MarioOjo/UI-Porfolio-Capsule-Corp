  ...
  return (
    <div className={`min-h-screen py-8 bg-gradient-to-br ${themeClass === 'dark' ? 'from-slate-900 to-slate-800' : 'from-blue-50 to-orange-50'}`}>
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          {trainingProducts.length > 0 ? (
            ...
            <div className="text-center py-12">
              <FaDumbbell className={`text-6xl mx-auto mb-4 ${themeClass === 'dark' ? 'text-gray-600' : 'text-gray-300'}`} />
        ...
        {/* Warning Section */}
        <div className={`rounded-2xl shadow-2xl overflow-hidden border-2 border-red-500 ${themeClass === 'dark' ? 'bg-red-900/20' : 'bg-red-50'}`}>
          <div className="p-8">
            <div className="flex items-center mb-4">
              <FaShieldAlt className="text-red-500 text-3xl mr-4" />
              <h3 className={`text-2xl font-bold font-saiyan ${themeClass === 'dark' ? 'text-white' : 'text-red-800'}`}>
                TRAINING SAFETY WARNING
              </h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h4 className={`text-lg font-bold mb-3 font-saiyan ${themeClass === 'dark' ? 'text-white' : 'text-red-800'}`}>
                  EXTREME TRAINING HAZARDS
                </h4>
                <ul className={`space-y-2 ${themeClass === 'dark' ? 'text-red-200' : 'text-red-700'}`}>
