...
import {
  ...
  render,
  setupStyleSheet
} from "./chunk-ZIWEFHPM.js";
import {
  onlineManager,
  useQueryClient
} from "./chunk-MOKNXS2M.js";
import {
  require_jsx_runtime
} from "./chunk-QW75WIBB.js";
import {
  require_react
} from "./chunk-EFH37R7F.js";
import {
  __toESM
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => import("./6ELMOJL2-ZLQRZTIS.js"));
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => import("./PULY4AJ7-ZAI5U3VA.js"));
        this.#Component = Devtools;
      }
      setupStyleSheet(this.#styleNonce, this.#shadowDOMTarget);
      return createComponent(Devtools, mergeProps({
